...
class _CozumListelemeState extends State<CozumListeleme> {
  ...
  // Future<void> _loadLikedCozumler( String cozumID, String userID, String sorunID, String konu) async {
  //   Kullanicilar? kullanici =
  //       Provider.of<KullaniciProvider>(context, listen: false).kullanicilar;
  //   if (kullanici != null) {
  //     List<String> userLikedCozumler = await _firestoreService.getUserLikedCozumler( kullanici.id);
  //     setState(() {
  //       likedCozumler = userLikedCozumler;
  //     });
  //   }
  // }
          ...
          children: [
            Expanded(
              ...
              child: Padding(
                ...
                child: Container(
                  width: width,
                  height: (selectedSorun.sorunMetni.length < 70)
                      ? height * 0.2
                      : styleTextProject
